...
<div
	...
	class="p-5 flex items-center gap-2 border rounded-lg border-black/10 dark:border-white/10 dark:bg-yellow-200/[3%] text-sm dark:text-neutral-50 mb-7 mt-5"
>
	...
	{#each projects as project, index}
		...
		>
			<div class="flex flex-row flex-grow w-full">
				...
				<img
					class="object-contain w-14 aspect-square ml-10"
					alt="icon"
					src={project.icon}
				/>
			</div>

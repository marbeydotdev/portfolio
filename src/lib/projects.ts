...
// 		],
// 		technologies: ['Supabase', 'NextJS', 'Docker']
// 	},
// 	// "DHLConsolidator": {
...
// 		description:
// 			'This project focused on creating a powerbank loaning system where users can sign up for an app, scan the qr code on a physical powerbank station and take out a powerbank. They can be returned to any of the powerbank stations.',
// 		features: [
...
// 				description:
// 					'The loaning history page, where users can see where and how long they loaned a powerbank.'
// 			},
// 			{
...
// 		description:
// 			'This project focused on creating the front-end for a questionnaire application that can be used to determine how well certain aspects of development are going within a team of people assigned to a project at a certain company.',
// 		features: [
...
// 		],
// 		technologies: ['SvelteKit', 'ASP.NET']
// 	}
// };
